        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    telefone_cliente = table.Column<string>(type: "varchar(20)", unicode: false, maxLength: 20, nullable: true),
                    endereco_cliente = table.Column<string>(type: "varchar(255)", unicode: false, maxLength: 255, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__Clientes__677F38F55B7E0813", x => x.id_cliente);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    telefone_funcionario = table.Column<string>(type: "varchar(20)", unicode: false, maxLength: 20, nullable: true),
                    departamento = table.Column<string>(type: "varchar(255)", unicode: false, maxLength: 255, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__Funciona__6FBD69C4B2D22A24", x => x.id_funcionario);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Servicos__D06FB5A29C3B848C", x => x.id_servico);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    tipo_declaracao = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: true),
                    data_declaracao = table.Column<DateTime>(type: "datetime", nullable: true),
                    conteudo_declaracao = table.Column<string>(type: "varchar(255)", unicode: false, maxLength: 255, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__Declarac__1132B261778DC845", x => x.id_declaracao);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id_transacao = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    id_cliente = table.Column<int>(type: "int", nullable: true),
                    tipo_transacao = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: true),
                    data_transacao = table.Column<DateTime>(type: "datetime", nullable: true),
                    valor_transacao = table.Column<decimal>(type: "decimal(10,2)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__Transaco__0FBBF7731E967A0E", x => x.id_transacao);
                    table.ForeignKey(
